...
namespace ProceduralWorlds.SceneOptimizer
{
    ...
    public static class EditorEvents
    {
        ...
        private static string EditorSaveMeshToDisk(Scene scene, Mesh sharedMesh)
        {
            string filePath = PWEvents.GetMeshPath(scene, sharedMesh);
            ...
            return filePath;//AssetDatabase.LoadAssetAtPath<Mesh>(filePath);
        }
