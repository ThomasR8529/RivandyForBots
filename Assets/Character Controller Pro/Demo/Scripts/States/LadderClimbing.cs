...
namespace Lightbug.CharacterControllerPro.Demo
{
    ...
    public class LadderClimbing : CharacterState
    {
        ...
        public override bool CheckEnterTransition(CharacterState fromState)
        {
            ...
            if (useInteractAction && !CharacterBrain.characterActions.interact.Started)
                return false;
        ...
        public override void UpdateBehaviour(float dt)
        {
            ...
            switch (state)
            {
                ...
                case LadderClimbState.Idling:
                    ...
                    if (CharacterBrain.characterActions.interact.Started)
                    {
                    ...
                    {
                        if (CharacterBrain.characterActions.movement.Up)
                        {
                        ...
                        else if (CharacterBrain.characterActions.movement.Down)
                        {
