...
namespace Lightbug.CharacterControllerPro.Demo
{
    ...
    public class RopeClimbing : CharacterState
    {
        ...
        {
            if (!currentRope.IsInRange(ReferencePosition) || CharacterBrain.characterActions.jump.Started)
        ...
        public override void ExitBehaviour(float dt, CharacterState toState)
        {
            ...
            {
                if (CharacterBrain.characterActions.movement.Detected)
        ...
        public override void UpdateBehaviour(float dt)
        {
            ...
            float targetAngularSpeed = CharacterBrain.characterActions.movement.value.x * angularSpeed;
            ...
            Vector3 targetVerticalVelocity = CharacterBrain.characterActions.movement.value.y * climbSpeed * CharacterActor.Up;
