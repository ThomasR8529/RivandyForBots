...
namespace Lightbug.CharacterControllerPro.Demo
{
    ...
    public class Dash : CharacterState
    {
        ...
        protected float lastDashTime = -Mathf.Infinity; // Moment du dernier dash.
        ...
        public override void EnterBehaviour(float dt, CharacterState fromState)
        {
            ...
            if (characterBrain.characterActions.movement.value.sqrMagnitude > 0.01f)
            {
                dashDirection = (characterBrain.characterActions.movement.value.y * CharacterActor.Forward + characterBrain.characterActions.movement.value.x * CharacterActor.Right).normalized;
            }
            else
            {
                // Si aucun input, utilise la direction du personnage
