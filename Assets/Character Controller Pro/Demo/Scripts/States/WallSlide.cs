...
namespace Lightbug.CharacterControllerPro.Demo
{
    ...
    public class WallSlide : CharacterState
    {
        ...
        {
            if (CharacterBrain.characterActions.crouch.value || CharacterActor.IsGrounded || !CharacterActor.WallCollision || !CheckCenterRay())
            {
                CharacterStateController.EnqueueTransition<NormalMovement>();
            }
            else if (CharacterBrain.characterActions.jump.Started)
            {
                wallJump = true;
        ...
        protected bool IsGrabbing => CharacterBrain.characterActions.run.value && enableGrab;
        ...
        public override void UpdateBehaviour(float dt)
        {
            if (IsGrabbing)
            {
                ...
                Vector3 targetVelocity = enableClimb ? CharacterBrain.characterActions.movement.value.x * rightDirection * wallClimbHorizontalSpeed +
                CharacterBrain.characterActions.movement.value.y * upDirection * wallClimbVerticalSpeed : Vector3.zero;
        ...
        public override void PostUpdateBehaviour(float dt)
        {
            ...
            CharacterActor.Animator.SetBool(movementDetectedParameter, CharacterBrain.characterActions.movement.Detected);
        ...
        public override void UpdateIK(int layerIndex)
        {
            ...
            if (IsGrabbing && CharacterBrain.characterActions.movement.Detected)
            {
