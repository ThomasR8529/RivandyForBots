...
namespace Lightbug.CharacterControllerPro.Demo
{
    ...
    public class Camera3D : MonoBehaviour
    {
        ...
        public UnityInputHandler inputHandler = null;
        ...
        public bool Initialize(Transform targetTransform)
        {
            ...
            // Mettre potentiellement un timer si y'a des soucies ici, UnityINputHundaler peut s'ajouter après
            inputHandler = GetComponent<UnityInputHandler>();
            return true;
        }
        ...
        public void SetSentivity(float sensitivity)
        {
            yawSpeed = sensitivity;
            pitchSpeed = sensitivity;
        }
