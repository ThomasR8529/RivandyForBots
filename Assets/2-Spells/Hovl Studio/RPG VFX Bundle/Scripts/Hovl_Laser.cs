...
public class Hovl_Laser : MonoBehaviour
{
    ...
    void Start ()
    {
        ...
        playerReference = spell.GetCaster().GetComponent<PlayerReference>();
    ...
    void Update()
    {
        ...
        if (Laser != null && UpdateSaver == false)
        {
            ...
            if (Physics.Raycast(playerReference.playerShooting.RayMouse.origin, playerReference.playerShooting.RayMouse.direction, out hit, Mathf.Infinity))
            {
                    //End laser position if collides with object
                    if (hit.collider.gameObject.layer == 3 || hit.collider.gameObject.layer == 9) {
            ...
            else
            {
                ...
                var EndPos = transform.position + playerReference.playerShooting.direction * MaxLength;
